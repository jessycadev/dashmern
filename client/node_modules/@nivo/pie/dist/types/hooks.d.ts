 ...
 * if `fit` is `true`.
 */
export declare const usePieFromBox: <RawDatum>({ data, width, height, innerRadius: innerRadiusRatio, startAngle, endAngle, padAngle, sortByValue, cornerRadius, fit, activeInnerRadiusOffset, activeOuterRadiusOffset, activeId: activeIdFromProps, onActiveIdChange, defaultActiveId, forwardLegendData, }: Pick<CompletePieSvgProps<RawDatum>, "sortByValue" | "innerRadius" | "padAngle" | "cornerRadius" | "startAngle" | "endAngle" | "fit" | "activeInnerRadiusOffset" | "activeOuterRadiusOffset" | "width" | "height"> & Pick<Partial<CompletePieSvgProps<RawDatum>>, "activeId" | "onActiveIdChange" | "defaultActiveId" | "forwardLegendData"> & {
    data: Omit<ComputedDatum<RawDatum>, "arc">[];
}) => {
    centerX: number;
    centerY: number;
