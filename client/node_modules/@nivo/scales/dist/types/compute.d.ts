...
export declare function computeScale<Input extends ScaleValue>(spec: ScaleSpec, data: ComputedSerieAxis<any>, size: number, axis: ScaleAxis): import("./types").ScaleLinear<number> | import("./types").ScalePoint<Input> | import("./types").ScaleBand<Input> | import("./types").ScaleTime<Date | import("d3-scale").NumberValue> | import("./types").ScaleLog | import("./types").ScaleSymlog;
/**
...
export declare const computeXYScalesForSeries: <S = never, D extends SerieDatum = SerieDatum>(series: Serie<S, D>[], xScaleSpec: ScaleSpec, yScaleSpec: ScaleSpec, width: number, height: number) => {
    ...
    xScale: import("./types").ScaleLinear<number> | import("./types").ScaleTime<Date | import("d3-scale").NumberValue> | import("./types").ScaleLog | import("./types").ScaleSymlog | import("./types").ScalePoint<D["x"]> | import("./types").ScaleBand<D["x"]>;
    yScale: import("./types").ScaleLinear<number> | import("./types").ScaleTime<Date | import("d3-scale").NumberValue> | import("./types").ScaleLog | import("./types").ScaleSymlog | import("./types").ScalePoint<D["y"]> | import("./types").ScaleBand<D["y"]>;
    x: {
        all: unknown[];
        min: unknown;
        max: unknown;
